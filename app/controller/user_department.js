...
exports.insert = async function (req, res) {
  ...
  var _insert = `INSERT INTO user_department (${key}) VALUES (${val})`;
...
exports.update = async function (req, res) {
  ...
  _data = _data.join(",");
  // LINE WAJIB DIBAWA
  var _update = `UPDATE user_department SET ${_data} WHERE department_id='${req.body.department_id}'`;
...
exports.delete = async function (req, res) {
  ...
  // LINE WAJIB DIBAWA
  var _delete = `DELETE FROM user_department  WHERE department_id = ${req.body.department_id}`;
